...
(Conditional Power Prior) approach with power parameter set to 0. It
...
- [`BinomialSeparate$new()`](#method-BinomialSeparate-new)

- [`BinomialSeparate$prepare_data()`](#method-BinomialSeparate-prepare_data)

- [`BinomialSeparate$sample_prior()`](#method-BinomialSeparate-sample_prior)

- [`BinomialSeparate$prior_pdf()`](#method-BinomialSeparate-prior_pdf)

- [`BinomialSeparate$prior_cdf()`](#method-BinomialSeparate-prior_cdf)
...
#### Usage
    ...
    BinomialSeparate$new(prior, mcmc_config)
...
#### Usage
    ...
    BinomialSeparate$sample_prior(n_samples)
...
#### Usage
    ...
    BinomialSeparate$prior_pdf(target_treatment_effect)
...
#### Usage
    ...
    BinomialSeparate$prior_cdf(target_treatment_effect)
