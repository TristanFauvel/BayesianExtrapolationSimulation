...
table_empirical_bayes_hyperparameters_vs_drift <- function(results_metrics_df,
  ...
  for (key in selected_parameters) {
    ...
    hyperparameter_colname <- sprintf(
      "%s%s",
...
#' This function tables for hyperparameters updated using Empirical Bayes
#' across different case studies, methods, and sample sizes.
#'
#' @param results_metrics_df A data frame containing the results metrics.
...
table_empirical_bayes_hyperparameters_vs_scenario <-
  function(results_metrics_df, metrics) {
